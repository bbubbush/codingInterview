...
public class SelectionSort {
     ...
     *  선택정렬 알고리즘을 구현한 메서드
     */
    private static int[] selectionSort(int[] arr, int startIdx, boolean isAscending) {
     ...
     */
    private static boolean isChange(int target, int minValue, boolean isAscending) {
     ...
     */
    private static void swap(int[] arr, int startIdx, int minIdx) {
